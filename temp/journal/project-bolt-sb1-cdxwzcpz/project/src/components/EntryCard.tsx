...
import { Calendar, Edit2, Trash2, Tag, Download } from 'lucide-react';
...
export function EntryCard({ entry, onEdit, onDelete, onDownload }: EntryCardProps) {
          ...
          <div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
            <button
              ...
              className="p-1.5 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 
                       text-gray-500 hover:text-green-600 dark:hover:text-green-400 transition-colors"
